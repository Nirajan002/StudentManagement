...
namespace backend.Migrations
{
    ...
    [Migration("20260925053203_Updated for Attendance")]
    partial class UpdatedforAttendance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Modules.AssignmentSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GroupPostId", "StudentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("backend.Modules.OtpCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserId", "UserType", "Purpose");
            ...
            modelBuilder.Entity("backend.Modules.Student", b =>
                {
                    ...
                    b.HasIndex("Class", "Section", "RollNumber")
                        .IsUnique()
            ...
            modelBuilder.Entity("backend.Modules.AssignmentSubmission", b =>
                {
                    b.HasOne("backend.Modules.GroupPost", "GroupPost")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Modules.ClassSection", b =>
                {
                    b.HasOne("backend.Modules.Teacher", "Instructor")
                        .WithMany()
